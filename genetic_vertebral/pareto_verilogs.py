...
def generate(identity,relusize,weight_size1,bias_size1,weight_size2,bias_size2,sparsity,inputsize,relusize_int,w1_int,b1_int,w2_int,b2_int,layer1,layer2,layer3,lrate,nepochs,X_train,Y_train,X_test,Y_test,pretrained1,pretrained2):
    ...
    callbacks= all_callbacks( outputDir = 'model_seeds_classification_Paretos')
