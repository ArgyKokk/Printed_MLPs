...
def generate(identity,layer1,layer2,layer3,lrate,nepochs,X_train,Y_train,X_test,Y_test,pretrained1,pretrained2):
    ...
    for i in sparsity_vals:
        ...
        pruning_params = {"pruning_schedule" : pruning_schedule.ConstantSparsity(i, begin_step=2000, frequency=100)}
        ...
        callbacks= all_callbacks( outputDir = 'model_cardio_classification_Pruning')
